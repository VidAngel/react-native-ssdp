...
// Jed: Added next line to bypass issue. https://github.com/tradle/react-native-udp/issues/131
if (dgram.default) dgram = dgram.default
...
SSDP.prototype._start = function (port, host, cb) {
  ...
  this.sock.addListener('listening', function onSocketListening() {
    if (!self && !self.sock && !self.sock.address()) return
